...
(function() {
  ...
  style.textContent = [
    ...
    '.rp-close{position:absolute;top:16px;right:16px;background:none;border:1px solid rgba(0,240,255,0.2);color:var(--text2);width:32px;height:32px;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:.9rem;border-radius:4px;transition:color .2s,border-color .2s;z-index:11}',
    ...
    ".rp-meta{display:flex;gap:8px;margin-top:4px;font-family:'Rajdhani',sans-serif;font-size:.65rem;font-weight:500;color:var(--text2)}",
    ...
    ".rp-info-lbl{display:block;font-family:'Rajdhani',sans-serif;font-size:.55rem;font-weight:500;letter-spacing:.15em;text-transform:uppercase;color:var(--text3);margin-bottom:2px}",
    ".rp-info-val{font-family:'Rajdhani',sans-serif;font-size:.85rem;font-weight:600}",
    ".rp-desc{font-family:'Exo 2',sans-serif;font-size:.88rem;font-weight:300;color:var(--text2);line-height:1.7;margin-bottom:20px;padding:14px;border-left:2px solid rgba(0,240,255,0.15);background:rgba(0,240,255,0.02);border-radius:0 4px 4px 0}",
    ".rp-section-title{font-family:'Orbitron',sans-serif;font-size:.6rem;font-weight:600;letter-spacing:.2em;text-transform:uppercase;color:var(--text2);margin-bottom:12px;padding-bottom:8px;border-bottom:1px solid}",
    ...
    ".rp-stat-lbl{display:block;font-family:'Rajdhani',sans-serif;font-size:.48rem;font-weight:500;letter-spacing:.1em;color:var(--text3)}",
    ...
    ".rp-power-desc{display:block;font-family:'Exo 2',sans-serif;font-size:.75rem;font-weight:300;color:var(--text2);margin-top:2px}",
    /* Admin section */
    ...
    ".rp-fl{display:block;font-family:'Rajdhani',sans-serif;font-size:.55rem;font-weight:600;letter-spacing:.15em;text-transform:uppercase;color:var(--text3);margin-bottom:4px}",
    ...
    ".rp-save-btn{width:100%;font-family:'Rajdhani',sans-serif;font-size:.75rem;font-weight:700;letter-spacing:.15em;text-transform:uppercase;color:var(--bg);background:linear-gradient(135deg,var(--cyan,#00f0ff),#80ffea);border:none;border-radius:3px;padding:12px;cursor:pointer;transition:background .3s,box-shadow .3s;margin-top:8px}",
    ...
    ".rp-stat-row-lbl{font-family:'Rajdhani',sans-serif;font-size:.5rem;font-weight:600;letter-spacing:.1em;color:var(--text3)}",
    ...
    ".rp-power-add{width:100%;margin-top:6px;padding:8px;border:1px dashed rgba(0,240,255,0.12);border-radius:4px;background:transparent;color:var(--text3);font-family:'Rajdhani',sans-serif;font-size:.72rem;letter-spacing:.1em;cursor:pointer;transition:border-color .2s,color .2s,background .2s}",
